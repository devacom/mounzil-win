...
class MenuWidget(QPushButton):
    def __init__(self, parent):
        ...
        icons = ':/' + \
            str(self.parent.mounzil_setting.value('settings/icons')) + '/'

        # add support for other languages
        locale = str(self.parent.mounzil_setting.value('settings/locale'))
        ...
        # set ui direction
        ui_direction = self.parent.mounzil_setting.value('ui_direction')
...
class DownloadTableWidget(QTableWidget):
    def __init__(self, parent):
        ...
        # set ui direction
        ui_direction = parent.mounzil_setting.value('ui_direction')
...
class MainWindow_Ui(QMainWindow):
    def __init__(self, mounzil_setting):
        ...
        self.mounzil_setting.beginGroup('settings/shortcuts')
        ...
        self.videoFinderAddLinkAction_shortcut = QShortcut(self.mounzil_setting.value(
        ...
        self.minimizeAction_shortcut = QShortcut(
            self.mounzil_setting.value('hide_window_shortcut'), self, self.minMaxTray)
        ...
        self.addlinkAction_shortcut = QShortcut(self.mounzil_setting.value(
        ...
        self.addtextfileAction_shortcut = QShortcut(
            self.mounzil_setting.value('import_text_shortcut'), self, self.importText)
        ...
        self.exitAction_shortcut = QShortcut(self.mounzil_setting.value('quit_shortcut'), self, self.closeAction)
        ...
        self.removeSelectedAction_shortcut = QShortcut(
            self.mounzil_setting.value('remove_shortcut'), self, self.removeSelected)
        ...
        self.deleteSelectedAction_shortcut = QShortcut(
            self.mounzil_setting.value('delete_shortcut'), self, self.deleteSelected)
        ...
        self.moveUpSelectedAction_shortcut = QShortcut(self.mounzil_setting.value(
        ...
        self.moveDownSelectedAction_shortcut = QShortcut(self.mounzil_setting.value(
        ...
        self.helpAction = QAction(QIcon(icons + 'about'), QCoreApplication.translate("mainwindow_ui_tr", 'Help'),
                                  self, statusTip=QCoreApplication.translate("mainwindow_ui_tr", 'Help'), triggered=self.mounzilHelp)
