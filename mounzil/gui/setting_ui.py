...
try:
    from PySide6.QtWidgets import QAbstractItemView, QTableWidget, QTableWidgetItem, QCheckBox, QVBoxLayout, QHBoxLayout, QFrame, QWidget, QLabel, QLineEdit, QTabWidget, QSpinBox, QPushButton, QSlider, QComboBox, QFontComboBox, QSpacerItem, QSizePolicy
    from PySide6.QtCore import Qt, QTranslator, QCoreApplication, QLocale
    from PySide6.QtGui import QIcon
except:
    from PyQt5.QtWidgets import QAbstractItemView, QTableWidget, QTableWidgetItem, QCheckBox, QVBoxLayout, QHBoxLayout, QFrame, QWidget, QLabel, QLineEdit, QTabWidget, QSpinBox, QPushButton, QSlider, QComboBox, QFontComboBox, QSpacerItem, QSizePolicy
    from PyQt5.QtCore import Qt, QTranslator, QCoreApplication, QLocale
    from PyQt5.QtGui import QIcon

from mounzil.gui.customized_widgets import MyQDateTimeEdit
...
class KeyCapturingWindow_Ui(QWidget):
    def __init__(self, mounzil_setting):
        ...
        # set ui direction
        ui_direction = self.mounzil_setting.value('ui_direction')
        ...
        global icons
        icons = ':/' + str(self.mounzil_setting.value('settings/icons')) + '/'
...
class Setting_Ui(QWidget):
    def __init__(self, mounzil_setting):
        ...
        # start mounzil in system tray if browser executed
        self.start_mounzil_if_browser_executed_checkBox = QCheckBox(self.style_tab)
        style_tab_verticalLayout.addWidget(self.start_mounzil_if_browser_executed_checkBox)
        ...
        self.download_folder_label = QLabel(self.download_options_tab)
        self.download_folder_horizontalLayout.addWidget(
            self.download_folder_label)

        self.download_folder_lineEdit = QLineEdit(self.download_options_tab)
        self.download_folder_horizontalLayout.addWidget(self.download_folder_lineEdit)

        self.download_folder_pushButton = QPushButton(self.download_options_tab)
        self.download_folder_horizontalLayout.addWidget(self.download_folder_pushButton)

        download_options_tab_verticalLayout.addLayout(self.download_folder_horizontalLayout)

        # temp_download_folder
        self.temp_horizontalLayout = QHBoxLayout()

        self.temp_download_label = QLabel(self.download_options_tab)
        self.temp_horizontalLayout.addWidget(self.temp_download_label)

        self.temp_download_lineEdit = QLineEdit(self.download_options_tab)
        self.temp_horizontalLayout.addWidget(self.temp_download_lineEdit)

        self.temp_download_pushButton = QPushButton(self.download_options_tab)
        self.temp_horizontalLayout.addWidget(self.temp_download_pushButton)

        download_options_tab_verticalLayout.addLayout(self.temp_horizontalLayout)

        # create subfolder
        self.subfolder_checkBox = QCheckBox(self.download_options_tab)
        download_options_tab_verticalLayout.addWidget(self.subfolder_checkBox)

        # video_finder
        
        video_finder_verticalLayout = QHBoxLayout()
        self.video_finder_label=QLabel(self.download_options_tab)
        video_finder_verticalLayout.addWidget(self.video_finder_label)
        download_options_tab_verticalLayout.addLayout(video_finder_verticalLayout)

        # max_links_label
        max_links_horizontalLayout = QHBoxLayout()
        self.max_links_label = QLabel(self.download_options_tab)
        max_links_horizontalLayout.addWidget(self.max_links_label)

        # max_links_spinBox
        self.max_links_spinBox = QSpinBox(self.download_options_tab)
        ...
        download_options_tab_verticalLayout.addLayout(max_links_horizontalLayout)

        self.video_finder_dl_path_horizontalLayout = QHBoxLayout()

        self.video_finder_frame = QFrame(self.download_options_tab)
        self.video_finder_frame.setLayout(download_options_tab_verticalLayout)
        ...
        self.volume_slider = QSlider(Qt.Orientation.Horizontal, self.sound_frame)
        self.volume_slider.setProperty("value", 100)
        self.volume_slider.setTickPosition(QSlider.TicksBothSides)
        verticalLayout.addWidget(self.volume_slider)
        ...
        self.video_finder_label.setText(QCoreApplication.translate("setting_ui_tr", 'Video Finder Options:'))

        self.max_links_label.setText(QCoreApplication.translate("setting_ui_tr", 'Maximum number of video links to capture:<br/>'
        ...
        self.start_mounzil_if_browser_executed_checkBox.setText(
            QCoreApplication.translate('setting_ui_tr', 'If browser is opened, start mounzil in system tray'))
        ...
        self.startup_checkbox.setText(QCoreApplication.translate("setting_ui_tr", "Run mounzil at startup"))
