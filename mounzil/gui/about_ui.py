...
class AboutWindow_Ui(QWidget):
    def __init__(self, mounzil_setting):
        ...
        # mounzil icon
        if qtsvg_available:
            mounzil_icon_verticalLayout = QVBoxLayout()
            self.mounzil_icon = QtSvgWidget.QSvgWidget(':/mounzil.svg')
            self.mounzil_icon.setFixedSize(QSize(64, 64))

            mounzil_icon_verticalLayout.addWidget(self.mounzil_icon)
            mounzil_icon_verticalLayout.addStretch(1)

            about_tab_horizontalLayout.addLayout(mounzil_icon_verticalLayout)
        ...
        # tabs
        self.about_tabWidget.addTab(self.about_tab, QCoreApplication.translate("about_ui_tr", "About mounzil"))
