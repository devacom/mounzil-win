...
class ProgressWindow_Ui(QWidget):
    def __init__(self, mounzil_setting):
        ...
        icons = ':/' + str(mounzil_setting.value('settings/icons')) + '/'
...
# window
        self.setMinimumSize(QSize(595, 272))

        self.setWindowIcon(QIcon.fromTheme('mounzil', QIcon(':/mounzil.svg')))
        self.setWindowTitle(QCoreApplication.translate("progress_ui_tr", "mounzil Download Manager"))
