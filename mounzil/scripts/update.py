...
# add support for other languages
        ...
        # installed version
        self.client_version = '0.3.1'

        # first line text
        self.update_label = QLabel(QCoreApplication.translate(
            "update_src_ui_tr", "The newest is the best, we recommend to update mounzil."))
        ...
        self.version_label = QLabel(QCoreApplication.translate(
            "update_src_ui_tr", 'This is Mounzil version 0.3.1'))
        ...
        try:
            ...
            if float(server_version) > float(self.client_version):
                self.status_label.setText(QCoreApplication.translate(
                    "update_src_ui_tr", 'A newer mounzil release is available'))
