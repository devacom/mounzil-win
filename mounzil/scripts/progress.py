...
from mounzil.gui.progress_ui import ProgressWindow_Ui
...
class ProgressWindow(ProgressWindow_Ui):
    def __init__(self, parent, gid, mounzil_setting):
...
# check if limit speed activated by user or not
        add_link_dictionary = self.parent.mounzil_db.searchGidInAddLinkTable(gid)
