...
from mounzil.gui.windows_notification_ui import Windows_Notification_UI
...
class Windows_Notification(Windows_Notification_UI):
    def __init__(self, parent, time, text1, text2, mounzil_setting):
        super().__init__(parent, mounzil_setting)
