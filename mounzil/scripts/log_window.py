...
from mounzil.gui.log_window_ui import LogWindow_Ui
...
# this method is refresh log messages in text_edit
    ...
    def closeEvent(self, event):
        ...
        self.mounzil_setting.setValue('LogWindow/size', self.size())
        self.mounzil_setting.setValue('LogWindow/position', self.pos())
