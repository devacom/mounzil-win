...
from mounzil.gui.video_finder_progress_ui import VideoFinderProgressWindow_Ui
...
class VideoFinderProgressWindow(VideoFinderProgressWindow_Ui):
    def __init__(self, parent, gid_list, mounzil_setting):
        ...
        add_link_dictionary = self.parent.mounzil_db.searchGidInAddLinkTable(gid_list[0])
    ...
    def closeEvent(self, event):
        ...
        self.mounzil_setting.setValue('ProgressWindow/size', self.size())
        self.mounzil_setting.setValue('ProgressWindow/position', self.pos())
        ...
        if self.status == "paused":
            ...
            if not(answer):
                ...
                if version_answer == 'did not respond':
                    ...
                    notifySend(QCoreApplication.translate("progress_src_ui_tr", "Aria2 disconnected!"), QCoreApplication.translate("progress_src_ui_tr", "mounzil is trying to connect! be patient!"),
        ...
        if self.status == "downloading":
            ...
            if not(answer):
                ...
                if version_answer == 'did not respond':
                    ...
                    notifySend("Aria2 disconnected!", "mounzil is trying to connect! be patient!",
                               10000, 'warning', parent=self.parent)
                else:
        ...
        # user unchecked limit_checkBox
            ...
            for i in [0, 1]:
                ...
                if status != 'scheduled':
                    ...
                    self.parent.mounzil_db.updateAddLinkTable([add_link_dictionary])
