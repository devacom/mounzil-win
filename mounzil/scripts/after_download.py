...
from mounzil.gui.after_download_ui import AfterDownloadWindow_Ui
...
class AfterDownloadWindow(AfterDownloadWindow_Ui):
    def __init__(self, parent, dict, mounzil_setting):
        ...
        self.add_link_dict = self.parent.mounzil_db.searchGidInAddLinkTable(gid)
...
#         download_path = file_name.join(file_path_split)
    ...
    def okButtonPressed(self):
        if self.dont_show_checkBox.isChecked():
            self.mounzil_setting.setValue('settings/after-dialog', 'no')
