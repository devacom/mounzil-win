...
from mounzil.gui.text_queue_ui import TextQueue_Ui
...
class TextQueue(TextQueue_Ui):
    def __init__(self, parent, file_path, callback, mounzil_setting):
...
# entry initialization
        ...
        # get values from mounzil_setting
        global connections
        connections = int(
        ...
        size = self.mounzil_setting.value('TextQueue/size', QSize(700, 500))
    ...
    def queueChanged(self, combo):
        if str(self.add_queue_comboBox.currentText()) == 'Create new queue':
            ...
            if new_queue:
                ...
                queues_list = self.parent.mounzil_db.categoriesList()
    ...
    def closeEvent(self, event):
        self.mounzil_setting.setValue('TextQueue/size', self.size())
        self.mounzil_setting.setValue('TextQueue/position', self.pos())
