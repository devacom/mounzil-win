...
# finding windows_size
        ...
        self.setWindowTitle('mounzil Download Manager')
        ...
        self.reset_mounzil_pushButton = QPushButton(self)
        self.reset_mounzil_pushButton.clicked.connect(
            self.resetPushButtonPressed)
        self.reset_mounzil_pushButton.setText('Reset mounzil')
        horizontalLayout.addWidget(self.reset_mounzil_pushButton)
