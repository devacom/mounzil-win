...
if os_type == 'Linux':
    ...
    path_list = ['/usr/local/share/man/man1/mounzil.1.gz',
                 '/usr/local/share/pixmaps/mounzil.svg',
                 '/usr/local/share/pixmaps/mounzil-tray.svg',
                 '/usr/local/share/applications/com.github.devacom.mounzil.desktop',
                 '/usr/local/share/metainfo/com.github.devacom.mounzil.appdata.xml',
                 '/usr/local/bin/mounzil']
...
# finding mounzil directories in /usr/lib/python3.6/site-packages/
...
for python_version in python_version_list:
    ...
    if os_type == 'Linux':
        ...
        pattern = '/usr/lib/' + python_version + '/site-packages/mounzil*'

    elif os_type == 'FreeBSD' or os_type == 'OpenBSD':

        pattern = '/usr/local/lib/' + python_version + '/site-packages/mounzil*'
